        ...
        public IPdfReportData CreatePdfReport()
        {
            ...
            .PagesHeader(header =>
            {
                ...
                header.DefaultHeader(defaultHeader =>
                {
                    ...
                    defaultHeader.ImagePath(System.IO.Path.Combine( "c:/plum/report/", "Images\\01.png"));
            ...
            .Generate(data => data.AsPdfFile(string.Format("{0}\\Pdf\\RptSqlDataReaderSample-{1}.pdf", "c:/plum/report/", Guid.NewGuid().ToString("N"))));
        }
    }
}